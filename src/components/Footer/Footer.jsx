...
function Footer() {
  ...
  return (
    <footer className="mt-8 pt-1 pb-2 text-gray-800 dark:text-gray-200">
      <hr className="h-px my-2 bg-gray-300 dark:bg-[#55626c] border-0"/>
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="text-center md:text-left mb-6 md:mb-0 w-full sm:w-auto">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2 mt-2">Dev Mittal</h2>
            <p className="text-gray-600 dark:text-gray-400">I love to explore and learn new things quickly.</p>
          </div>
          <div className="flex space-x-4 w-full md:w-auto justify-center md:justify-start">
            <Link to="https://github.com/DevMit29" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white">
            ...
            <Link to="https://instagram.com/devmit29" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white">
              <svg className="w-6 h-6" fill={theme==='dark'?'currentColor':'dark'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <Link to="https://x.com/DevMitt29" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white">
              <svg className="w-6 h-6" fill={theme==='dark'?'currentColor':'dark'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <Link to="https://www.linkedin.com/in/devmit29" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white cursor-pointer">
              <svg className="w-6 h-6" fill={theme==='dark'?'currentColor':'dark'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <Link to="https://www.youtube.com/@devmit29" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white cursor-pointer">
              <svg className="w-6 h-6" fill={theme==='dark'?'currentColor':'dark'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <div className="mt-4 text-center md:text-start text-gray-600 dark:text-gray-400 text-sm">
